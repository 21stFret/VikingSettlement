...
public class AttackCooldownUI : MonoBehaviour
{
    ...
    public void OnWeaponDurability()
    {
        ...
        if (_trackedWeapon.CurrentDurability <= 5)
        {
            ...
            InfoPopupUI.Push("Weapon Durability Low!", "Your weapon is about to break! Repair it at the <color=cyan>Grindstone</color>.", _trackedWeapon.itemSpriteRenderer.sprite);
        }
        else
        {
            lowDurability = false;
